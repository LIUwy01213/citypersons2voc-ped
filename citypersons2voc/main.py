...
citypersons_annotaions_dir = Path('./citypersons_annotations')
...
cityperson_image_root_dir = Path('/media/ise2/data/rawdata/Detection/leftImg8bit_trainvaltest/leftImg8bit/')
